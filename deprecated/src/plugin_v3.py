...
# The resulting 'adoptees' map (mep) takes a taxon of any rank and
# maps it to a list of species that would be newly added to A in
# changing it to be more like B.
